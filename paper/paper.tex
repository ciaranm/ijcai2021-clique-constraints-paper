...
based upon finding a maximum clique in the neighbourhood of each domain vertex, which
is valid even in the general case. Although this new filtering technique involves solving
