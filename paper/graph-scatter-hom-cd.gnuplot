...
set title "Homomorphism (Both)"

plot \
    "runtimes.data" u (sx("fatanode-results/gss-noninjective-nosupplementals-20210102",1)):(sx("fatanode-results/gss-cliques-noninjective-20210102",1)):(getpt("instance")):(getlc("instance")) w p pt var lc pal ps 0.5, \
    x w l ls -1
